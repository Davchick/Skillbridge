  ...
  return (
    <div className="p-6 flex flex-col gap-y-5 border rounded-[10px] max-w-[598px]">
      <div className="flex justify-between items-center gap-x-4">
        ...
        <div
          className={`p-[18px] rounded-md relative bg-primary-950 hover:bg-primary-900 cross-hover transition duration-300 ${
      ...
      {isOpen && (
        <div>
          ...
          <div className="py-3 px-5 flex items-center justify-between bg-light-970 rounded-md hover:bg-light-950 border">
